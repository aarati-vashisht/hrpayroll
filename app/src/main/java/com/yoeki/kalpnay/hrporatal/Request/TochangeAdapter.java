...
public class TochangeAdapter extends BaseAdapter {

    Context mContext;
    LayoutInflater inflater;
    private List<TochangeModel> tochangelist;

    public TochangeAdapter(Context context, ArrayList<TochangeModel> tochangelist){
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder.departmentname.setText(tochangelist.get(position).getDepartmentname());
