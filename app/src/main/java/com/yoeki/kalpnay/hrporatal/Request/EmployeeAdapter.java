...
public class EmployeeAdapter extends BaseAdapter {
    ...
    private List<GetMasterInfo.ListEmployee> tochangelist;

    public EmployeeAdapter(Context context, List<GetMasterInfo.ListEmployee> tochangelist){
        mContext = context;
    ...
    @Override
    public GetMasterInfo.ListEmployee getItem(int position) {
