...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private float mFinalLeftAvatarPadding,mFinalLeftAvatarMargin;
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        mFinalLeftAvatarMargin = context.getResources().getDimension(
                R.dimen.spacing_normalv); }
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, CircleImageView child, View dependency) {
        ...
        Log.d("expandedPercentag",expandedPercentageFactor+"  "+mChangeBehaviorPoint);
        if (expandedPercentageFactor < mChangeBehaviorPoint) {
            //closed
            Log.d("expandedPer",expandedPercentageFactor+"  "+mChangeBehaviorPoint);
            ...
            lp.leftMargin=(int)30;
            child.setLayoutParams(lp);
        } else {
            //opened
            Log.d("expanded",expandedPercentageFactor+"  "+mChangeBehaviorPoint);
            float distanceYToSubtract = ((mStartYPosition - mFinalYPosition)
